        ...
        <div id="step1" class="d-flex-col  w-full  h-auto bg-white  ">
            <div class=" d-flex ">
                <div class="w-[50%] border-b  border-r-2 p-5 d-flex-col gap-5 p-4 border-gray-300 h-[200px]">
                    ...
                    <input id="display-value" value="5000 DH"
                           class="border-none w-[100px] rounded-md shadow-inner inset-2 p-1 text-base font-bold text-blue-600 "
                           readonly type="text">
                    <input id="default-range" step="1000" type="range" min="5000" max="600000"
                           onmousemove="switchValue(value)" value="5000"
                ...
                <div class="w-[50%] border-b  p-5 d-flex-col gap-5 p-4 border-gray-300 h-[200px]">
                    ...
                    <input id="displayMounth" value="12"
                           class="border-none w-[70px] rounded-md shadow-inner inset-2 p-1 text-base font-bold text-blue-600 "
                           readonly type="text">
                    <input id="defaultMounth" type="range" step="6" min="12" max="120" onmousemove="switchValue(value)"
                           value="12"
                           class="w-full h-1 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700">
            ...
            <div class="w-full   d-flex justify-around items-center h-[66px] border-b border-blue-100">
                <div class="d-flex gap-4">
                    ...
                    <input id="totalInput" type="text" value=""
                           class="border-none w-[100px] rounded-md shadow-inner inset-2 p-1 text-base font-bold text-blue-600 ">
...
<section id="slideInfo" class="w-[300px] h-[98vh] position-absolute top-[13%] left-[98%] bg-white">
    ...
    <span id="buttonSlide" onclick="displaySlide()"
          class="w-[50px] bg-blue position-absolute rotate-[181deg] top-[40%] left-[-9%] text-center h-[50px] rounded-full"><i
